...
export class ProfessoresService {
  private apiUrl = 'https://api.apiatividade.duckdns.org/teacher/';  // Nova URL da API
  private cursosUrl = 'https://api.apiatividade.duckdns.org/courses'; // Caso precise acessar cursos também

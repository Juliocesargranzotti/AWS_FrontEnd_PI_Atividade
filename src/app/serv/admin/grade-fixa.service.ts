...
export class GradeFixaService {
  private apiUrl = 'https://api.apiatividade.duckdns.org/reservation/';
  private teachersUrl = 'https://api.apiatividade.duckdns.org/teacher/';
  private subjectsUrl = 'https://api.apiatividade.duckdns.org/subject/';
  private timesUrl = 'https://api.apiatividade.duckdns.org/time/';
  private roomsUrl = 'https://api.apiatividade.duckdns.org/rooms/';
  private coursesUrl = 'https://api.apiatividade.duckdns.org/course/';

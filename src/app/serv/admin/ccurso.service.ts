...
export class CcursoService {
  private apiUrl = 'https://api.apiatividade.duckdns.org/course/';  // URL principal para cursos
  private disciplinesUrl = 'https://api.apiatividade.duckdns.org/subject/';  // URL para buscar as disciplinas
